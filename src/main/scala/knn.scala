...
object knn {
  ...
  def classify(trainFeats: Array[Array[Double]], trainLabels: Array[String], numOfFeats: Int, x: Array[Double], N: Int): String = {
    /**
  ...
  def eval(predictedLabels: Array[String], acutalLabels: Array[String]): Int = (predictedLabels zip acutalLabels).count(t => t._1 == t._2) / acutalLabels.length
